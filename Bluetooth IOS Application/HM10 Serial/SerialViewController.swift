...
//MARK: BluetoothSerialDelegate
    ...
    // MARK: Buttons addition
    // Kevins code addition/////////////////////////////////
    @IBAction func left() {
        print("left button was clicked" );
        serial.sendMessageToDevice("L");
    }
    
    @IBAction func backwads() {
        
        print("backwads button was clicked" );
        serial.sendMessageToDevice("B");

    }
    
    @IBAction func straight() {
        print("straight button was clicked" );
    ...
    @IBAction func right45() {
             print("right45 button was clicked" );
             serial.sendMessageToDevice("r");
     }
    
    @IBAction func left45() {
        print("left45 button was clicked" );
        serial.sendMessageToDevice("l");
     }
    
    @IBAction func helloB() {
    ...
    @IBAction func turnOff() {
        print("TurnOff button was clicked" );
        serial.sendMessageToDevice("N");
     }
    
    // MARK: New Buttons 4.0
    @IBAction func one() {
        print("1st button was clicked" );
        serial.sendMessageToDevice("1");
     }
    @IBAction func two() {
        print("2nd button was clicked" );
        serial.sendMessageToDevice("2");
     }
    @IBAction func three() {
        print("3rd button was clicked" );
        serial.sendMessageToDevice("3");
     }

    @IBAction func four() {
        print("4th button was clicked" );
